...
_PAIR_MODE_GUIDANCE = {
    "연인": {
        ...
        "subtitle": "애정 표현과 거리감을 맞추는 관계",
        "face_summary": (
            "{left_name}님과 {right_name}님은 애정 표현의 속도와 편안한 거리감을 "
            "서로 확인할수록 감정의 온도가 안정적으로 살아날 수 있어요."
        ),
        "guidance": {
            "first_impression": (
                (
                    "연인 관계에서는 첫 끌림만큼 상대가 편안함을 느끼는 거리와 표현 방식을 "
                    "천천히 확인하는 것이 도움이 될 수 있어요."
                ),
                (
                    "연인 사이에서는 처음의 호감이 오래 이어지려면 서로가 부담을 느끼지 "
                    "않는 속도를 함께 찾아가는 것이 좋아요."
                ),
                (
                    "가까워지는 과정에서는 설렘을 서두르기보다 상대가 편안해지는 반응과 "
                    "거리감을 살피면 관계의 온도가 더 안정될 수 있어요."
                ),
            ),
            "communication": (
                (
                    "서운함이 생길 때는 바로 결론을 내리기보다 감정이 올라온 이유와 원하는 "
                    "반응을 짧게 나누면 회복이 쉬워질 수 있어요."
                ),
                (
                    "애정 표현이 엇갈릴 때는 상대의 마음을 시험하기보다 필요한 말과 반응을 "
                    "구체적으로 알려주는 편이 도움이 될 수 있어요."
                ),
                (
                    "감정이 예민해지는 순간에는 길게 설명하기보다 지금 필요한 위로와 확인을 "
                    "먼저 나누는 방식이 더 부드럽게 맞을 수 있어요."
                ),
            ),
            "strength": (
                (
                    "서로의 표현 방식이 다를수록 애정 표현, 안정감, 확인의 말을 나누어 "
                    "채우면 관계의 강점이 더 부드럽게 살아날 수 있어요."
                ),
                (
                    "한 사람은 마음의 온도를 살피고 다른 사람은 관계의 중심을 잡아주는 식으로 "
                    "강점을 나누면 애정의 안정감이 커질 수 있어요."
                ),
                (
                    "다른 표현 방식은 어긋남보다 보완점으로 볼 수 있으니, 서로가 편안해지는 "
                    "애정 언어를 찾아두면 장점이 더 오래 이어질 수 있어요."
                ),
            ),
            "caution": (
                (
                    "가까운 사이일수록 상대가 알아줄 것이라 넘기지 말고, 서운한 지점과 "
                    "필요한 거리감을 말로 확인하는 편이 도움이 될 수 있어요."
                ),
                (
                    "연인 사이에서는 침묵이 배려처럼 보여도 오해로 쌓일 수 있으니, 불편한 "
                    "감정은 짧고 부드럽게 꺼내는 편이 좋아요."
                ),
                (
                    "서로의 마음을 단정하기보다 확인하는 대화를 남겨두면, 작은 서운함이 "
                    "관계 전체의 불안으로 커지는 것을 줄일 수 있어요."
                ),
            ),
        },
    },
    "친구": {
        ...
        "subtitle": "편안한 대화와 자율성을 나누는 관계",
        "face_summary": (
            "{left_name}님과 {right_name}님은 대화 템포와 각자의 자유로운 거리를 "
            "존중할수록 부담 없는 친밀감이 오래 이어질 수 있어요."
        ),
        "guidance": {
            "first_impression": (
                (
                    "친구 관계에서는 처음의 호감보다 함께 있을 때 긴장이 줄어드는지, "
                    "농담과 침묵이 모두 편안한지가 중요한 기준이 될 수 있어요."
                ),
                (
                    "친구 사이에서는 첫인상의 강한 끌림보다 같이 있을 때 부담이 줄고 "
                    "자연스럽게 쉬어갈 수 있는지가 더 중요할 수 있어요."
                ),
                (
                    "처음에는 다른 점이 보여도 서로의 리듬을 가볍게 받아들일 수 있다면 "
                    "편안한 친밀감으로 이어질 가능성이 있어요."
                ),
            ),
            "communication": (
                (
                    "농담이나 가벼운 반응도 서로 다르게 받아들일 수 있으니, 편한 사이일수록 "
                    "장난의 선과 진심을 구분해주면 도움이 될 수 있어요."
                ),
                (
                    "편한 관계일수록 말을 짧게 넘기기 쉬우니, 서운할 수 있는 농담은 한 번 더 "
                    "가볍게 확인해주는 태도가 좋아요."
                ),
                (
                    "대화에서는 깊은 조언보다 먼저 들어주는 반응이 더 편할 때가 있으니, "
                    "상대가 원하는 대화의 깊이를 맞추면 좋아요."
                ),
            ),
            "strength": (
                (
                    "서로를 과하게 고치려 하기보다 각자의 취향, 생활 리듬, 쉬는 방식을 "
                    "인정할 때 친구 관계의 자연스러운 장점이 살아날 수 있어요."
                ),
                (
                    "각자 다른 방식으로 즐기고 쉬는 점을 인정하면, 함께할 때는 즐겁고 떨어져 "
                    "있을 때도 부담 없는 관계로 이어질 수 있어요."
                ),
                (
                    "서로의 차이를 평가하기보다 재미있는 개성으로 받아들이면 친구 사이의 "
                    "편안한 지속력이 더 잘 살아날 수 있어요."
                ),
            ),
            "caution": (
                (
                    "편하다는 이유로 서운함을 장난처럼 넘기지 말고, 필요한 거리감이나 "
                    "싫은 표현은 가볍지만 분명하게 말하는 편이 도움이 될 수 있어요."
                ),
                (
                    "친한 사이일수록 당연하게 여기는 부분에서 서운함이 생길 수 있으니, "
                    "작은 약속과 말의 선은 편하게 확인해두면 좋아요."
                ),
                (
                    "자유로운 관계를 오래 유지하려면 연락 빈도나 만나는 방식도 서로에게 "
                    "부담이 되지 않는 선에서 맞춰가는 편이 도움이 될 수 있어요."
                ),
            ),
        },
    },
    "직장동료": {
        ...
        "subtitle": "역할과 피드백 기준을 맞추는 관계",
        "face_summary": (
            "{left_name}님과 {right_name}님은 역할 분담, 결정 기준, 피드백 방식을 "
            "분명히 할수록 협업의 안정감과 효율이 더 잘 살아날 수 있어요."
        ),
        "guidance": {
            "first_impression": (
                (
                    "직장동료 관계에서는 친밀감보다 함께 일할 때의 신뢰감, 책임감, 기본 "
                    "태도를 어떻게 맞추는지가 더 중요한 기준이 될 수 있어요."
                ),
                (
                    "함께 일할 때는 첫인상의 호감보다 약속을 지키는 방식과 업무를 대하는 "
                    "기본 태도가 관계의 안정감을 더 크게 만들 수 있어요."
                ),
                (
                    "업무 관계에서는 서로가 편한 사람인지보다 필요한 정보를 믿고 주고받을 수 "
                    "있는지가 첫 흐름의 핵심이 될 수 있어요."
                ),
            ),
            "communication": (
                (
                    "업무 소통에서는 감으로 이해했다고 넘기기보다 일정, 담당자, 결정 사항을 "
                    "짧게 확인하는 습관이 도움이 될 수 있어요."
                ),
                (
                    "함께 일할 때는 말투보다 기준이 중요하니, 요청 내용과 마감 시점을 "
                    "짧게 정리해두면 오해가 줄어들 수 있어요."
                ),
                (
                    "의견이 다를 때는 사람의 성향보다 업무 기준을 먼저 놓고 이야기하면 "
                    "피드백이 훨씬 덜 부담스럽게 전달될 수 있어요."
                ),
            ),
            "strength": (
                (
                    "서로의 강점을 역할로 나누면 한 사람은 방향을 잡고 다른 한 사람은 "
                    "검토와 마무리를 챙기는 식의 협업 장점이 살아날 수 있어요."
                ),
                (
                    "업무에서는 각자의 장점을 성격 차이로 두기보다 담당 영역으로 나눌 때 "
                    "협업의 효율이 더 안정적으로 살아날 수 있어요."
                ),
                (
                    "한쪽이 흐름을 넓게 보고 다른 쪽이 세부 기준을 챙기는 식으로 역할을 "
                    "정하면 결과물의 완성도가 더 좋아질 수 있어요."
                ),
            ),
            "caution": (
                (
                    "책임 범위나 피드백 기준이 흐려지면 오해가 생길 수 있으니, 중요한 일은 "
                    "말투보다 기준, 역할, 마감선을 먼저 정리하는 편이 도움이 될 수 있어요."
                ),
                (
                    "업무 관계에서는 좋은 의도만으로 진행하면 책임이 흐려질 수 있으니, "
                    "결정권과 확인 절차를 미리 나누어두는 편이 좋아요."
                ),
                (
                    "서로의 속도가 다를수록 중간 점검 없이 오래 맡겨두기보다 짧은 확인 "
                    "지점을 정해두면 불필요한 부담을 줄일 수 있어요."
                ),
            ),
        },
    },
