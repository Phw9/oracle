...
RUN_ORACLE_LLM_TIMEOUT_SECONDS="${RUN_ORACLE_LLM_TIMEOUT_SECONDS:-}"
RUN_ORACLE_FACE_LLM_TIMEOUT_SECONDS="${RUN_ORACLE_FACE_LLM_TIMEOUT_SECONDS:-}"
RUN_ORACLE_REPORT_LLM_TIMEOUT_SECONDS="${RUN_ORACLE_REPORT_LLM_TIMEOUT_SECONDS:-}"
...
apply_run_config() {
  local effective_llm_timeout
  local effective_face_llm_timeout
  local effective_report_llm_timeout

  effective_llm_timeout="${RUN_ORACLE_LLM_TIMEOUT_SECONDS:-${ORACLE_LLM_TIMEOUT_SECONDS:-300}}"
  effective_face_llm_timeout="${RUN_ORACLE_FACE_LLM_TIMEOUT_SECONDS:-${ORACLE_FACE_LLM_TIMEOUT_SECONDS:-$effective_llm_timeout}}"
  effective_report_llm_timeout="${RUN_ORACLE_REPORT_LLM_TIMEOUT_SECONDS:-${ORACLE_REPORT_LLM_TIMEOUT_SECONDS:-3600}}"
  ...
  export ORACLE_LLM_TIMEOUT_SECONDS="$effective_llm_timeout"

  export ORACLE_FACE_LLM_BASE_URL="$RUN_ORACLE_LLM_BASE_URL"
  export ORACLE_FACE_LLM_MODEL="$RUN_ORACLE_FACE_LLM_MODEL"
  export ORACLE_FACE_LLM_TIMEOUT_SECONDS="$effective_face_llm_timeout"
  ...
  export ORACLE_REPORT_LLM_TIMEOUT_SECONDS="$effective_report_llm_timeout"
